...
public class ActivityExpenseController {
    ...
    @PostMapping public ApiResponse<ExpenseDetailResponse> create(@PathVariable Long activityId, @Validated({Default.class, CreateExpenseValidation.class}) @RequestBody SaveExpenseRequest request) { return ApiResponse.success(expenseService.create(activityId, request)); }
    ...
    @PostMapping("/{expenseId}/void") public ApiResponse<ExpenseDetailResponse> voidExpense(@PathVariable Long activityId, @PathVariable Long expenseId, @Valid @RequestBody VoidExpenseRequest request) { return ApiResponse.success(expenseService.voidExpense(activityId, expenseId, request)); }
}
