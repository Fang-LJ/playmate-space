...
public class PollController {
 ...
 @PostMapping("/{pollId}/close") public ApiResponse<PollDetailResponse> close(@PathVariable Long activityId,@PathVariable Long pollId,@RequestBody(required = false) ClosePollRequest request){return ApiResponse.success(pollService.close(activityId,pollId,request));}
