...
public class ActivityExpenseEntity {
    ...
    private String splitMode; private LocalDateTime expenseTime; private Long receiptFileId; private String description; private Long createdBy; private String clientRequestId;
    ...
    public Long getCreatedBy(){return createdBy;} public void setCreatedBy(Long v){createdBy=v;} public String getClientRequestId(){return clientRequestId;} public void setClientRequestId(String v){clientRequestId=v;} public String getStatus(){return status;} public void setStatus(String v){status=v;}
