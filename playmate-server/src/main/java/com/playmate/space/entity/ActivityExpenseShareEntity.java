...
public class ActivityExpenseShareEntity {
    ...
    private Long expenseId; private Long userId; private BigDecimal shareAmount; private BigDecimal splitRatio; private LocalDateTime createTime; private LocalDateTime updateTime;
    ...
    public BigDecimal getSplitRatio(){return splitRatio;} public void setSplitRatio(BigDecimal v){splitRatio=v;}
