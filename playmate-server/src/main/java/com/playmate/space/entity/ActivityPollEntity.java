...
public class ActivityPollEntity {
    ...
    private String resultApplyMode; private String resultApplyStatus; private Long winnerOptionId; private Integer targetItineraryVersion; private String itineraryTemplate;
